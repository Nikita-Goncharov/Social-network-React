...
function ProfileItem(props) {
  console.log(props.ownProfile.id, props.profile.id)
  return (
    <div className={styles.profile_item}>
      ...
      <div>
        <RenderIfAuthorized
          render={
            props.ownProfile.id !== props.profile.id ?
              <button className={styles.profile_follow_button}
                      onClick={() => props.followUnfollowProfile(props.profile.id, props.profile.followed)}>
