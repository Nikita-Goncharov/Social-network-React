...
function RegisterUser(props) {
  ...
  return <>
    <div className={styles.register_form}>
      <h1>Register</h1>
      <input onChange={updateInputValuesCallback} value={props.username} type="text" name="username"
             placeholder="Username"/>
      <input onChange={updateInputValuesCallback} value={props.email} type="text" name="email" placeholder="Email"/>
      <input onChange={updateInputValuesCallback} value={props.password1} type="password" name="password1"
             placeholder="Password 1"/>
      <input onChange={updateInputValuesCallback} value={props.password2} type="password" name="password2"
